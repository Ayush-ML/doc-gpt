...
X_train[categorical_cols] = pd.get_dummies(X_train, columns=[categorical_cols], drop_first=True)
X_test[categorical_cols] = pd.get_dummies(X_test, columns=[categorical_cols], drop_first=True)
