...
data = pd.read_csv(r'stroke\data\raw\stroke-dataset.csv')
...
X_train.to_csv(r"stroke\data\clean\train\X_train.csv", index=False)
y_train.to_csv(r"stroke\data\clean\train\y_train.csv", index=False)

X_test.to_csv(r"stroke\data\clean\test\X_test.csv", index=False)
y_test.to_csv(r"stroke\data\clean\test\y_test.csv", index=False)