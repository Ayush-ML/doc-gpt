...
# Create a Function used to fetch the current Step Response

def _get_step_response(current_step: int, state: AgentState) -> str:
...
def run(state: AgentState) -> dict:
    ...
    agent_response = _get_step_response(state=state, current_step=current_step) # Get Step Response ofr current Step
